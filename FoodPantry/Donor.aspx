<%@ Page Title="" Language="C#" MasterPageFile="~/FoodPantry.Master" AutoEventWireup="true" CodeBehind="Donor.aspx.cs" Inherits="WebApplication1.Donor" %>
        ...
        <br />
            <div class="input-group add-on">
                ...
                <div class="input-group-btn">
                    <button class="btn btn-default" type="submit"><i class="glyphicon glyphicon-search" style="color:#a41e35"></i></button>
                </div>
            </div>         
     </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-2">
		<div class="col-lg-9 col-md-8">
			<asp:DropDownList class="btn btn-default dropdown-toggle" ID="DropDownList2" runat="server">
				<asp:ListItem Enabled="true" Text="Select Date" Value="-1"></asp:ListItem>
...
<div class="row">
    ...
    <div class="col-md-2">
		<div class="col-lg-9 col-md-8">
			<asp:DropDownList class="btn btn-default dropdown-toggle" ID="DropDownList3" runat="server">
				<asp:ListItem Enabled="true" Text="Select Date" Value="-1"></asp:ListItem>
